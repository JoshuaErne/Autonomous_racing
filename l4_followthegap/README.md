# Follow the Gap
Implemented a gap follow algorithm to make the car drive autonomously around the Levine Hall map. 
## Review of F1TENTH Follow the Gap

The steps are outlined over here:
